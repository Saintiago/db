...
abstract class BaseBookPeer {
	...
	{
		// invalidate objects in LibraryRecordPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BookPeer::doOnDeleteCascade(new Criteria(BookPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += BookPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = BookPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related LibraryRecord objects
			$criteria = new Criteria(LibraryRecordPeer::DATABASE_NAME);
			
			$criteria->add(LibraryRecordPeer::BOOK_ID, $obj->getId());
			$affectedRows += LibraryRecordPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
