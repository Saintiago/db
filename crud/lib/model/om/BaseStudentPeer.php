...
abstract class BaseStudentPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in GraduationPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(LibraryUserPeer::STUDENT_ID, $obj->getId());
			...
			$criteria->add(LectureAttendancyPeer::STUDENT_ID, $obj->getId());
			$affectedRows += LectureAttendancyPeer::doDelete($criteria, $con);

			// delete related Graduation objects
			$criteria = new Criteria(GraduationPeer::DATABASE_NAME);
			
			$criteria->add(GraduationPeer::STUDENT_ID, $obj->getId());
			$affectedRows += GraduationPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
